/**
 * @file Vector.cpp
 * @brief Vect dual-representation helpers and operator overloads.
 */
...
/**
 * @brief Store Cartesian components and derive polar form.
 *
 * Negative magnitudes (if ever produced) are folded into a positive mag with
 * arg shifted by 180° so polar form stays conventionally non-negative.
 */
